class AddColumnToAttendances < ActiveRecord::Migration[5.1]
  def change
    ...
    # 勤怠編集
    add_column :attendances, :edit_started_at, :datetime                # 変更申請用出社時間
    add_column :attendances, :edit_finished_at, :datetime               # 変更申請用退社時間
    add_column :attendances, :before_started_at, :datetime              # 変更前出社時間
    add_column :attendances, :before_finished_at, :datetime             # 変更前退社時間
    add_column :attendances, :next_day, :boolean                        # 翌日チェックボックス
    ...
    add_column :attendances, :overwork_next_day, :boolean               # 翌日チェックボックス
    ...
    add_column :attendances, :change, :boolean                          # 変更のチェックボックス
  end
end
