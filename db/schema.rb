...
ActiveRecord::Schema.define(version: 20210107135703) do
  ...
  create_table "attendances", force: :cascade do |t|
    ...
    t.datetime "previous_scheduled_end_time"
    t.boolean "previous_overwork_next_day"
    t.string "previous_work_details"
    t.string "previous_overwork_status"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "basic_work_time", default: "2021-02-05 23:00:00"
